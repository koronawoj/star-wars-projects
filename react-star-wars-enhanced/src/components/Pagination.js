...
import {changePage, fetchDone, fetchPeople, fetchPerson, setActivePeople} from "../actions";
...
export default connect(mapStateToProps, {})(withRouter(withStyles(styles)(Pagination)))
